...
# clone from https://github.com/reverse-shell/routersploit/blob/master/routersploit/shell.py
...
class ReverseShell(object):
    ...
    def echo(self, binary, location):
        ...
        for i in range(0, num_parts):
            current = i * 30
            print_warning("Transferring {}/{} bytes".format(current, len(self.revshell)))
